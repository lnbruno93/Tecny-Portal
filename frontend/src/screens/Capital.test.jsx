...
vi.mock('../lib/api', () => ({
  ...
  inventario: {
    metricas: vi.fn().mockResolvedValue({
      ...
      stock_disponible: '4',
      // 2026-07-11 F3-Fase2c: campos legacy inv_equipos_* / inv_accesorios_*
      // y *_count desaparecieron del response. `inv_por_clase[]` es la
      // fuente única — Capital.jsx ya no tiene fallback.
      inv_por_clase: [
