...
// task #310 (split UX): link "Ver gráficos" al lado del subtítulo lleva a
// /resumen/graficos preservando el período seleccionado. Los charts en sí
// viven ahora en screens/ResumenGraficos.jsx.
    ...
    <div>
      ...
      <div className="page-head">
        <div>
          ...
          <div className="page-sub u-flex-center-gap-8">
            <span>Comparativo de período + KPIs operativos consolidados.</span>
            {/* task #310: link a la sub-vista de gráficos analíticos.
                Preserva el período seleccionado vía query param para que la
                navegación no pierda contexto. */}
            <Link to={`/resumen/graficos?periodo=${periodoActual}`} className="btn-link">
              Ver gráficos →
            </Link>
          </div>
        </div>
