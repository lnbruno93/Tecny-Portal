...
// 2026-07-12 (auditoría TOTAL Financiero P1-4): borrado
// `recalcComprobantesFinancieraByTenant`. Estaba marcado `@deprecated` desde
// D-01 audit (2026-06-30) con 40+ líneas de jsdoc explicando por qué NO
// llamarla — pero seguía exportada. Trampa esperando a un dev futuro que la
// vea y la llame desde un script admin sin darse cuenta del bug P0
// documentado (recalcular pct histórico retroactivamente rompe integridad
// contable). También borro `tests/config-recalc.test.js` (smoke test del
// helper deprecado). Si algún día se necesita un flow admin de re-sealing
// forzado, se escribe desde cero con contexto fresco (YAGNI resuelto en
// ~30min post-hoc si aparece).
