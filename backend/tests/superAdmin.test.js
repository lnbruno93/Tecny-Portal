...
beforeAll(async () => {
  ...
  // Auditoría 2026-06-30 S-25: super-admin requiere 2FA habilitada para
  // pasar requireSuperAdmin middleware. Insertamos row en user_2fa con
  // enabled_at set para que los tests pasen.
  await pool.query(`
